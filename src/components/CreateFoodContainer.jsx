...
const CreateFoodContainer = () => {
  ...
  return (
    <>
      <div
        className="w-[150px] flex items-center gap-2 justify-start  px-4 py-1 hover:bg-orange-200 rounded-full cursor-pointer"
        onClick={() => navigate("/menuManager")}
      >
      ...
      <div className="w-full min-h-screen flex items-center justify-center">
        <div className="w-[90%] md:w-[50%] border border-gray-300 rounded-lg p-4 flex flex-col items-center justify-center gap-4">
          <p className="text-gray-700 text-2xl">Create Food</p>
