...
export default function LiveOrder() {
  ...
  const columns = [
    ...
    },
    {
      ...
      headerName: "PREPARE TIME (Edit)",
      width: 280,
      editable: true,
      type: "singleSelect",
      valueOptions: ["10min", "20min", "30min"],
      headerClassName: "customColumn",
    },
  ...
  return (
    <>
      <div className="flex items-center justify-between mt-4 mb-4">
        <h1 className="text-gray-700 text-4xl font-semibold">Live Orders</h1>
        <span className="text-red-700">
          *Orders are automatically rejected after 10 minutes if you do not
          accept or reject.
        </span>
        <Stack
        ...
        >
          <Alert severity="success" variant="filled">
            ...
            <p className="font-semibold text-xl">Order Status is updated!</p>
          </Alert>
        </Stack>
      </div>
      <Box
      ...
      <div className="flex flex-col">
        ...
        >
            ...
            {selectedOrder && (
              <div className="mt-8 p-4">
                ...
                <div className="flex justify-end items-end">
                  <p className="font-semibold text-2xl mt-4 mr-4">
                    Total Price
                  </p>
          ...
          <div className="h-20">
            ...
            {selectedOrder?.orderStatus === "Order Placed" ? (
              <div className="inline rounded-md bg-emerald-500 absolute right-10">
